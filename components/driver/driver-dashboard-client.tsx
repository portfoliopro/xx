...
export default function DriverDashboardClient({ profile, availableOrders: initialAvail, myOrders: initialMine, history, userId }: Props) {
  ...
  async function acceptOrder(orderId: string) {
    ...
    if (accepted) {
      ...
      setMyOrders([{ ...accepted, driver_id: userId, status: 'picked_up' }, ...myOrders])
    }
